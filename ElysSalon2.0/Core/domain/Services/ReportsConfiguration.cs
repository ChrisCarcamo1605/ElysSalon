...
{
    DateTime Week1Start = DateTime.Now;
    DateTime Week1End = DateTime.Now;

    DateTime Week2Start = DateTime.Now;
    DateTime Week2End = DateTime.Now;

    DateTime Week3Start = DateTime.Now;
    DateTime Week3End = DateTime.Now;

    DateTime Week4Start = DateTime.Now;
    DateTime Week4End = DateTime.Now;
